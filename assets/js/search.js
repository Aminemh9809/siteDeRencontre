...
let women3 = new information('87','Charlotte', 'women3.jpg', 'femme', '32', 'Ventes', 'Cuisine', `Cuisiner est ma thérapie, et j'adore essayer des plats de différentes cuisines. Quand je ne suis pas en cuisine, j'aime explorer de nouveaux endroits et rencontrer de nouvelles personnes.`,'homme');

let women4 = new information('88', 'Aurélie','women4.jpg', 'femme', '33', 'RH', 'Voyages', `Je suis une passionnée de voyages avec un amour pour la découverte de nouvelles cultures et cuisines. Que ce soit une escapade à la plage ou une randonnée aventureuse, comptez sur moi !`,'homme');

let women5 = new information('89', 'Clara','women5.jpg', 'femme', '34', 'Finance', 'Photographie', `J'ai l'œil pour le détail et j'aime capturer des moments à travers la photographie. La finance est mon travail de jour, mais la photographie est ma véritable passion.`,'homme');

let women6 = new information('90','Léa' ,'women6.jpg', 'femme', '35', 'TI', 'Musique', `La musique est ma vie, et j'aime jouer différents instruments. Je suis aussi un geek de la technologie et j'adore rester à jour avec les dernières tendances de l'industrie.`,'homme');

let women7 = new information('91','Chloé' ,'women7.jpg', 'femme', '36', 'Opérations', 'Art', `La créativité est ma force, et je l'exprime à travers diverses formes d'art. Je suis aussi adepte du fitness et je crois en le maintien d'un mode de vie sain et équilibré.`,'homme');

let women8 = new information('92','Manon' ,'women8.jpg', 'femme', '37', 'Gestion de produit', 'Danse', `La danse est mon moyen de déstresser, et j'apprécie diverses formes de danse. Dans ma vie professionnelle, je prospère dans l'innovation de produits et la résolution de problèmes.`,'homme');

let women9 = new information('93', 'Lucie','women9.jpg', 'femme', '38', 'Support client', 'Jeux vidéo', `Je suis une joueuse dans l'âme et j'adore me plonger dans des mondes virtuels. Quand je ne joue pas, je suis dévouée à fournir un support client de premier ordre.`,'homme');

let women10 = new information('94', 'Éléonore','women10.jpg', 'femme', '39', 'Juridique', 'Sports', `J'ai une passion pour le sport, tant pour jouer que pour regarder. Dans ma vie professionnelle, je m'engage à faire respecter la justice et à garantir la conformité légale.`,'homme');
